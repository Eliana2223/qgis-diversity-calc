    ...
    def run(self):
        ...
        if result:
            ...
            for category, summary in dctMain.items():
                ...
                twiCat = QTreeWidgetItem(dlgResult.trwResults, [category, str(total), str(dc_richness(summary)), "{3.3f}".format(dc_evenness(summary)), "{3.3f}".format(dc_shannons(summary)), "{3.3f}".format(dc_simpsons(summary))])
